use lca_core::{
    DemandItem, InterSystemLink, LcaMatrix, LcaSystem, SparseMatrix, sparse_matrix::Triplete,
};
...
mod tests {
    ...
    fn test_compile_bike_example() {
        ...
        assert_eq!(
            system.demands().as_ref().unwrap().len(),
    ...
    fn test_compile_toaster_example() {
        ...
        pollster::block_on(async {
            ...
            let result = eval_system.evaluate().await.expect("LCA evaluation failed");
