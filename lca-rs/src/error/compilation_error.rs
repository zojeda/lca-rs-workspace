...
pub enum LcaModelCompilationError {
    ...
    #[error("Process '{0}' product output name '{1}' does not match process name")]
    ProcessProductMismatch(String, String),

    #[error("Process '{0}' product output '{1}' has non-positive amount: {2}")]
    NonPositiveProductAmount(String, String, f32),

    #[error("Process '{0}' input '{1}' has negative amount: {2}")]
    NegativeInputAmount(String, String, f32), // Second String will be formatted ProductRef
